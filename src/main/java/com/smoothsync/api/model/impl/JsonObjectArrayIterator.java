 ...
 * <p/>
 * Note this assumes that the array contains only objects! If an element is not a {@link JSONObject} calling {@link #next()} will fail with an {@link
 * IllegalArgumentException}.
 *
 * @author Marten Gajda <marten@dmfs.org>
 */
public final class JsonObjectArrayIterator extends AbstractBaseIterator<JSONObject>
{
