...
public interface Service
{
    ...
    /**
     * Returns a {@link KeyStore} that contains certificates valid for this Service.
     *
     * @return A {@link KeyStore} or {@¢ode null} if the service didn't contain a {@link KeyStore}.
     */
    KeyStore keyStore();
}
